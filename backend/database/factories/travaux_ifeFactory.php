...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\travaux_ife>
 */
class travaux_ifeFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        return [
            ...
            'croquis' => $this->faker->text(),
            'vidage' => $this->faker->text(),
            'image' => $this->faker->imageUrl(),
            'cin' => $this->faker->text(),
            'riverain' => $this->faker->text(),
            'Centroïde' => $this->faker->word(),
        ];
    }
}
